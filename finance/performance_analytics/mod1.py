...
def active_premium(portfolio_returns, benchmark_returns, scale=12):
    ...
    # or possibly even a panel for the returned data.
...
def information_ratio(portfolio_returns, benchmark_returns, scale=12):
    ...
    ap = active_premium(portfolio_returns, benchmark_returns, scale=12)
    te = tracking_error(portfolio_returns, benchmark_returns, scale=12)
